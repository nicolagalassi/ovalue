      ...
      <div class="flex items-center gap-2 flex-shrink-0">
        ...
        <div class="relative" v-if="activeProfile">
          <button
            ...
            class="h-8 flex items-center gap-2 px-3 rounded-lg bg-slate-800 border border-slate-600 hover:border-slate-500 hover:bg-slate-700 transition-all text-slate-200"
          >
          ...
          >
            <div v-if="isProfileMenuOpen" class="absolute right-0 top-full mt-1.5 w-52 bg-[#111827] border border-slate-600 rounded-xl shadow-[0_8px_32px_rgba(0,0,0,0.7)] z-50 overflow-hidden">
        ...
        <div class="relative">
          <button
            ...
            class="h-8 flex items-center gap-1.5 px-2.5 rounded-lg bg-slate-800 border border-slate-600 hover:border-slate-500 hover:bg-slate-700 transition-all text-slate-200"
          >
          ...
          <Transition enter-active-class="transition duration-150 ease-out" enter-from-class="opacity-0 -translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100" leave-to-class="opacity-0">
            <div v-if="isLangMenuOpen" class="absolute right-0 top-full mt-1.5 w-36 bg-[#111827] border border-slate-600 rounded-xl shadow-[0_8px_32px_rgba(0,0,0,0.7)] z-50 overflow-hidden">
        ...
        <router-link
          to="/settings"
          class="w-8 h-8 flex items-center justify-center rounded-lg bg-slate-800 border border-slate-600 hover:border-slate-500 hover:bg-slate-700 transition-all"
          :class="$route.path === '/settings' ? 'text-slate-200 border-slate-500 bg-slate-700' : 'text-slate-400 hover:text-slate-200'"
          title="Impostazioni"
        >
