  ...
  <div class="card-glass p-1 relative group flex flex-col transition-all duration-500 hover:shadow-neon-blue hover:-translate-y-1">
    ...
    <div class="bg-black/20 rounded-t-xl p-4 flex justify-between items-center border-b border-white/5">
        ...
        <div class="flex gap-2">
            <button @click="emit('clone')" :title="t('btn_clone')" aria-label="Clone" class="p-2 bg-blue-500/10 hover:bg-blue-500/30 text-blue-400 rounded-lg transition">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
            </button>
            <button @click="emit('remove')" :title="t('btn_delete')" aria-label="Delete" class="p-2 bg-red-500/10 hover:bg-red-500/30 text-red-400 rounded-lg transition">
    ...
    <div class="p-5 space-y-5 flex-grow">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label class="block text-[10px] uppercase font-bold text-gray-500 mb-1 truncate">Magma Forge</label>
            ...
            <div>
                <label class="block text-[10px] uppercase font-bold text-gray-500 mb-1 truncate">Kaelesh (Human)</label>
        ...
        <div class="bg-gradient-to-r from-ogame-warning/5 to-transparent p-3 rounded-lg border border-ogame-warning/10">
            <div class="flex justify-between items-center mb-2">
                ...
                <span class="text-[9px] text-gray-400">Max: <span class="text-gray-200 font-bold">{{ breakdown.maxCraw }}</span></span>
            </div>
            ...
            <div class="flex items-center justify-between mt-3">
                ...
                <span v-if="breakdown.isCrawCapReached" class="text-[9px] bg-red-900/50 text-red-200 px-2 py-0.5 rounded border border-red-500/30">CAP Reached</span>
            </div>
        </div>
    ...
    <div class="bg-black/40 rounded-b-xl p-4 border-t border-white/5 backdrop-blur-md">
        ...
        <div class="pt-3 border-t border-white/10 flex justify-between items-end">
            <span class="text-xs text-gray-500 font-bold uppercase">Totale / h</span>
